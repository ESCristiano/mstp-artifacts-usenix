# Non-Secure (NS) world runtime environment

This folder provides the Non-Secure (NS) world runtime environment, with an RTOS.
This folder provide the necessary means to run the experiments presented in **Sections 6.1**, **6.2**, and **6.3** in a RTOS setting. 
